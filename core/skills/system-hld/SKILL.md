...
name: system-hld
description: >-
  After SPEC alignment, produces compact system high-level design under AI_CONTEXT/:
  SYSTEM_HLD.md plus SYSTEM_HLD.contract.yaml for downstream skills (/slice, feature-*).
  Invoke as /system-hld when AI_CONTEXT/SPEC.md is concrete enough to bound architecture
  (typically after /grillme). Does not replace per-feature design skills.
---
