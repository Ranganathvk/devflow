...
- **Optional:** `AI_CONTEXT/<FEATURE>_DB.contract.yaml`, `<FEATURE>_API.contract.yaml` when delivery flags require them.
...
| Path | Change | Notes |
|------|--------|-------|
| `AI_CONTEXT/<FEATURE>_TDD.md` | Created or replaced | |
| `AI_CONTEXT/<FEATURE>_TDD.contract.yaml` | Created or replaced | |
