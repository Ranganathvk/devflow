...
- **Optional:** `artifacts/<FEATURE>_DB.contract.yaml`, `<FEATURE>_API.contract.yaml` when delivery flags require them.
- **Optional:** `artifacts/SPEC.md`, `artifacts/SYSTEM_HLD.contract.yaml`.
...
4. Write `artifacts/<FEATURE>_TDD.md` and `artifacts/<FEATURE>_TDD.contract.yaml` — set `workflow_profile: devflow`.
...
| Path | Change | Notes |
|------|--------|-------|
| `artifacts/<FEATURE>_TDD.md` | Created or replaced | |
| `artifacts/<FEATURE>_TDD.contract.yaml` | Created or replaced | |
...
feature_db_contract_path: artifacts/<FEATURE>_DB.contract.yaml
feature_api_contract_path: artifacts/<FEATURE>_API.contract.yaml
