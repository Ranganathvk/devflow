...
Pop **one** task from an **approved** `artifacts/<FEATURE>_TASKS.contract.yaml` queue and implement with minimal blast radius.
...
2. **Load** `*_TASKS.contract.yaml` and `artifacts/<FEATURE>.contract.yaml`.
