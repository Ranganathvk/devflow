...
- **Required (all modes):** `artifacts/SPEC.md`.
- **Required (task/queue):** `artifacts/<FEATURE>_TASKS.contract.yaml` with `tasks_status: approved`.
- **Required (lite):** `artifacts/<FEATURE>.contract.yaml`.
- **Optional:** `artifacts/<FEATURE>_TDD.contract.yaml`, `artifacts/SYSTEM_HLD.contract.yaml`, `artifacts/FEATURE_SLICES.contract.yaml`, `artifacts/PROJECT_STATE.md`.
...
| `artifacts/<FEATURE>_TASKS.contract.yaml` | Task/queue | `done` + clear `current_task` on success |
| `artifacts/PROJECT_STATE.md` | Optional | If present or requested |
